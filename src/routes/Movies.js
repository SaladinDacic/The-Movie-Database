...
function Movies({props}) {
  ...
  useEffect(() => {
    (async function getData(){
      let moviesList = await getMovies("movies")
  ...
  return (
    <div>
      <MethodsProvider {...props}>
        <Landing linkRef="movies" searchFilter={searchFilter} movies={movies} cardClicked={cardClicked} setCardClicked={setCardClicked}/>
      </MethodsProvider> 
    </div>
  )
}
